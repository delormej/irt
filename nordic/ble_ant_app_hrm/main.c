 ...
 * application starts. The received data will be propagated to a BLE master through the
...
#define DEVICE_NAME                     "nrf51922_HRM"                               /**< Name of device. Will be included in the advertising data. */
