...
/**@brief		Returns the number of wheel revolutions.
 *
 *@note			Approx. 19 flywheel revolutions per 1 2.07m wheel revolution.
 */
uint16_t get_wheel_revolutions()
{
	...
	*/
	...
	// TODO: Use m_wheel_size to accurately calculatoe 
