...
{    
    ...
    // default applicable networks to ANT+ and BTLE.
...
{
    NSLog(@"sensorConnected notification received");
    NSDictionary* info = notification.userInfo;
    if ( info != nil )
    {
        // parse the user info.
        WFSensorConnection* connectionInfo = (WFSensorConnection*)[info objectForKey:@"connectionInfo"];
