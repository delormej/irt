...
static void conn_params_init(void)
{
    ...
    cp_init.start_on_notify_cccd_handle    = m_cps.cprc_handles.cccd_handle; // BLE_GATT_HANDLE_INVALID; // m_hrs.hrm_handles.cccd_handle; // TODO: need to change this and remove hrs service.
