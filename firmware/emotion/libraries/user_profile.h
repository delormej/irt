...
#define PROFILE_VERSION					15u	            // Current version of the profile.
...
typedef struct user_profile_s {
	...
	uint8_t		power_average_seconds:7;	// In erg/sim mode, window size (in seconds) for averaging power and speed.
